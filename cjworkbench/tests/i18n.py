...
class TransTest(SimpleTestCase):
    def test_format_invalid_default(self):
        ...
        with self.assertRaises(InvalidICUParameters):
            trans(default_locale, mock_message_id, default="Hello {a} {0} {b}", parameters={'a': 'you', '0': '!', 'b': '2'}),
    ...
    def test_format_invalid_message(self):
        ...
        '''
        self.assertEqual(MessageTranslator(default_locale).process_message('Hello {a} {0} {b}', 'Hello {a} {b}', parameters={'a': 'you', 'b': '!'}), 'Hello you !')
