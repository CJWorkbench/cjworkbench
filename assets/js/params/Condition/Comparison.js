...
export default class Comparison extends React.PureComponent {
  ...
  render () {
    ...
    const column = (inputColumns || []).find(c => c.name === value.column) || null
        ...
        {(column && isText) ? (
          <div className='text-options'>
            <label className='case-sensitive'>
              ...
              />
              <Trans id='js.params.Condition.Comparison.caseSensitive'>Case-sensitive</Trans>
            </label>
            <label className='regex'>
              ...
              />
              <Trans id='js.params.Condition.Comparison.regex'>Regular expression</Trans>
            </label>
          </div>
        ) : null}
        {onDelete ? (
