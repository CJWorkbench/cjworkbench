...
const ComponentNotFound = ({ name }) => (
  <p className='error'><Trans id='js.params.Custom.ComponentNotFound.error' comment='The parameter will the the name of the custom type'>Custom type {name} not handled</Trans></p>
)
