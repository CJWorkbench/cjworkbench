...
const Algorithms = [
  {
    name: 'fingerprint',
    selectName: t('RefineClusterer.fingerprint')`Fingerprint`,
    description: t('RefineClusterer.groupvalues.fingerprint')`Group values by fingerprint. This method is effective when values are capitalized irregularly or if special characters are used in some and not others. For instance, "café" and "Cafe" both have the same fingerprint, "cafe".`,
    defaultOptions: null,
    optionFields: null,
