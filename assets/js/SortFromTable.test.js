...
describe("SortFromTable actions", () => {
  ...
  it('selects the existing sort module when updating it', async () => {
    ...
    updateTableActionModule(17, idName, false, 'str_col', 'text');
  ...
  it('orders a String column ascending by default', async () => {
    ...
    updateTableActionModule(17, idName, false, 'str_col', 'text', sortDirectionAsc);
  ...
  it('orders a Data column descending by default', async () => {
    updateTableActionModule(17, idName, false, 'date_col', 'datetime', sortDirectionDesc);
  ...
  it('resets ordering state when changing sort column', async () => {
    ...
    updateTableActionModule(79, idName, false, 'str_col', 'text', sortDirectionAsc);
