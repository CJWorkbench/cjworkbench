...
var SessionStoreNowOffset = require("../../util/SessionStoreNowOffset");
...
function parseXY(config, _chartProps, callback, parseOpts) {
	...
	if (bySeries.hasDate) {
		...
		scale.dateSettings.inputTZ = scale.dateSettings.inputTZ || SessionStoreNowOffset
	}
	...
	var typeSettingsDefaults = clone(config.defaultProps.chartProps.scale.typeSettings);
