  ...
  return (
    <div className='unhandled-error-report'>
      <div className='content'>
        <h2>
          <Trans id='js.UnhandledErrorReport.content.oops'>
            Oops! Something isn't right.
          </Trans>
        </h2>
        <p>
          <Trans id='js.UnhandledErrorReport.content.pleaseFollowSteps'>
            Please follow these simple steps to help us fix the issue.
          </Trans>
        </p>
        <div className='help-us-debug'>{helpText}</div>
        <p>
          <Trans id='js.UnhandledErrorReport.content.thankYou'>
            THANK YOU! Refresh this page to return to your Workflow.
          </Trans>
        </p>
        <p>
          <Trans id='js.UnhandledErrorReport.content.debuggingDetails'>
            Debugging details (please send):
          </Trans>
        </p>
        <pre>{bugReportText}</pre>
        <div className='actions'>
          <button type='button' onClick={() => window.location.reload()}>
            <Trans id='js.UnhandledErrorReport.actions.refreshPageButton'>
              Refresh page
            </Trans>
          </button>
        </div>
