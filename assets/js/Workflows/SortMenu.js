      ...
      <div className='sort-menu'>
        <UncontrolledDropdown>
          ...
          <DropdownMenu>
            ...
            <DropdownItem data-comparator='last_update|ascending' onClick={this.handleClickComparator}><Trans id='js.Workflows.SortMenu.oldestModified.dropdownItem' comment='Last update ascending'>Oldest modified</Trans></DropdownItem>
            <DropdownDivider />
