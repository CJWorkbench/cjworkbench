            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <div className="import-url-field">
                <input type="text"
                      ...
                      />
              <div className="label-margin t-m-gray info-1">Learn more about how to build your own module <a target="_blank" href="http://cjworkbench.org/index.php/build-a-module/" className=' t-f-blue'>here</a></div>
              </div>
              {visible}
            </form>
          </ModalBody>
