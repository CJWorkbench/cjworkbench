...
def start_authorize(
    ...
    try:
        ...
        return TemplateResponse(request, "oauth_token_request_denied.html", status=403)
...
def finish_authorize(request: HttpRequest) -> HttpResponse:
    ...
    offline_token = service.acquire_refresh_token_or_str_error(request.GET, scope.state)
    ...
    async_to_sync(websockets.ws_client_send_delta_async)(workflow.id, delta_json)
