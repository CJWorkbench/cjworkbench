...
class SaveTests(DbTestCase):
    def test_store_if_changed(self):
        ...
        self.run_with_async_db(save_result_if_changed(wf_module,
                                                      ProcessResult(table)))
    ...
    def test_storage_limits(self):
        ...
        for i in range(0, 4):
            ...
            self.run_with_async_db(
                save_result_if_changed(wf_module, ProcessResult(table))
            )
    ...
    def test_race_deleted_workflow(self):
        ...
        # Don't crash
        self.run_with_async_db(save_result_if_changed(wf_module, result))
        assert True
