...
class UndoRedoTests(DbTestCase):
    ...
    def test_undo_redo(self):
        ...
        # Change a parameter
        cmd2 = self.run_with_async_db(ChangeParametersCommand.create(
            workflow=workflow,
        ...
        cmd3 = self.run_with_async_db(ChangeWorkflowTitleCommand.create(
            workflow=workflow,
            new_value='New Title'
        ))
        v3 = cmd3.id
        ...
        cmd4 = self.run_with_async_db(ChangeWfModuleNotesCommand.create(
            workflow=workflow,
            wf_module=wfm,
        ...
        workflow.refresh_from_db()
        self.assertEqual(workflow.last_delta_id, v1)
        cmd5 = self.run_with_async_db(ChangeWfModuleNotesCommand.create(
            workflow=workflow,
