...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "fetch_error",
                    models.CharField(
                        blank=True, max_length=2000, verbose_name="fetch_error"
                    ),
                ),
        ...
        migrations.AlterUniqueTogether(
            name="moduleversion", unique_together=set([("id_name", "last_update_time")])
        ),
        migrations.AddField(
            model_name="delta",
        ...
        migrations.AlterUniqueTogether(
            name="tab", unique_together=set([("workflow", "slug")])
        ),
        migrations.AddField(
        ...
        migrations.AlterUniqueTogether(
            name="aclentry", unique_together=set([("workflow", "email")])
        ),
    ]
