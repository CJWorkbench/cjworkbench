...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='wfmodule',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('inprogress_file_upload_id__isnull', True), ('inprogress_file_upload_key__isnull', True), ('inprogress_file_upload_last_accessed_at__isnull', True)), models.Q(('inprogress_file_upload_id__isnull', False), ('inprogress_file_upload_key__isnull', False), ('inprogress_file_upload_last_accessed_at__isnull', False)), models.Q(('inprogress_file_upload_id__isnull', True), ('inprogress_file_upload_key__isnull', False), ('inprogress_file_upload_last_accessed_at__isnull', False)), _connector='OR'), name='inprogress_file_upload_check'),
        ),
    ]
